...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasherInterface, string $token = null): Response
    {
        ...
        try {
            ...
            $this->addFlash('reset_password_error', sprintf(
                'Un problème est survenu pendant la requête de demande de nouveau mot de passe - %s',
                $e->getReason()
            ));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Ton nouveau mot de passe est bien enregistré.');
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('no-reply@le-bestiaire.richardmeuret.dev', 'Le Bestiaire'))
            ->to($user->getEmail())
